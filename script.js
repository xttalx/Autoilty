...
window.FALLBACK_PRODUCTS = [
  ...
  // Additional Auto Products (20 similar products)
  {
    id: '11',
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=400&h=400&fit=crop',
    description: 'Premium pH-balanced car shampoo for safe and effective cleaning.',
    featured: true,
    new: false,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1542751110-97427bbecf20?w=400&h=400&fit=crop',
    description: 'Deep conditioning treatment for automotive leather seats.',
    featured: true,
    new: true,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=400&h=400&fit=crop',
    description: 'Long-lasting tire shine for a glossy, professional finish.',
    featured: false,
    new: false,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop',
    description: 'Heavy-duty degreaser for engine bay cleaning.',
    featured: false,
    new: true,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=400&h=400&fit=crop',
    description: 'Complete kit to restore cloudy and yellowed headlights.',
    featured: true,
    new: false,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1600948836101-f9ffda59d250?w=400&h=400&fit=crop',
    description: 'Professional clay bar for removing embedded contaminants.',
    featured: false,
    new: false,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=400&h=400&fit=crop',
    description: 'All-purpose interior cleaner and protectant.',
    featured: false,
    new: true,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1542751110-97427bbecf20?w=400&h=400&fit=crop',
    description: 'High-pressure foam cannon for thick, clinging suds.',
    featured: true,
    new: false,
    in_stock: true,
  },
  {
    id: '19',
    name: 'Drying Towel XL',
    price: 35.99,
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=400&h=400&fit=crop',
    description: 'Extra-large waffle weave drying towel for quick water removal.',
    featured: false,
    new: false,
    in_stock: true,
  },
  ...
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1600948836101-f9ffda59d250?w=400&h=400&fit=crop',
    description: 'Professional-grade polishing pads for paint correction.',
    featured: true,
    new: false,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=400&h=400&fit=crop',
    description: 'Light spray for quick touch-ups between washes.',
    featured: false,
    new: false,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1542751110-97427bbecf20?w=400&h=400&fit=crop',
    description: 'Effective bug and tar remover for front-end cleaning.',
    featured: false,
    new: true,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=400&h=400&fit=crop',
    description: 'Soft foam applicator pads for wax application.',
    featured: false,
    new: false,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop',
    description: 'Portable steam cleaner for deep interior cleaning.',
    featured: true,
    new: true,
    in_stock: true,
  },
  {
    id: '27',
    name: 'Vacuum Extension Kit',
    price: 29.99,
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=400&h=400&fit=crop',
    description: 'Extension kit for reaching tight spaces in vehicles.',
    featured: false,
    new: false,
    in_stock: true,
  },
  {
    ...
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1600948836101-f9ffda59d250?w=400&h=400&fit=crop',
    description: 'UV-protectant spray for dashboard and interior plastics.',
    featured: false,
    new: false,
    in_stock: true,
  },
  {
    id: '29',
    name: 'Pressure Washer Soap',
    price: 26.99,
    category: 'auto',
    image: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=400&h=400&fit=crop',
    description: 'Concentrated soap designed for pressure washers.',
    featured: false,
    new: true,
    in_stock: true,
  },
